...
### Core Components
1. **Main Stored Procedure**: `Laboratory POC Comparison (updated July 2025).sql`
...
- **Permissions**: Read access to laboratory data tables
...
- **Current State**: v1.7.1 (final development state)
- **Next Release**: v1.8.0 (README.md completion)
- **Major Milestone**: v2.0.0 (public GitHub release)
...
- Update mappings in main stored procedure
